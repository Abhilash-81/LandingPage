    ...
    <div className="w-full min-h-screen bg-[#f4f5f7]">
      <div className="flex flex-col items-center justify-between">
        <div className="bg-[#00FEFE] m-4 p-4">
          <h1 className="font-bold text-3xl sm:text-4xl lg:text-6xl leading-8">
            Who are we
          </h1>
        </div>
      ...
      <div className="flex flex-col items-center justify-start space-y-4 m-8 p-8 font-bold text-base sm:text-lg lg:text-xl leading-normal tracking-tight opacity-50 text-center">
        ...
        <h1>
          experience and execution, and funds from the people of the startup
          ecosystem, like entrepreneurs, successful
        </h1>
